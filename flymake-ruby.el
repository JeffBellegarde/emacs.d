...
(defun flymake-ruby-rbenv-executable ()
  (flymake-ruby-chomp (shell-command-to-string (concat "cd " (file-name-directory buffer-file-name) ";" "rbenv " "which " "ruby"))))
...
(defun flymake-ruby-init ()
  (let* ((temp-file (flymake-init-create-temp-buffer-copy
    ...
    (list (flymake-ruby-rbenv-executable) (list "-c" local-file))))
